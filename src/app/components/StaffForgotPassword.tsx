...
const COOLDOWN_KEY = "staff_forgot_password_cooldown_end";
...
export default function StaffForgotPassword() {
  ...
  const handleFindAccount = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Verify the email belongs to a staff/admin account
      ...
      if (!roleData) {
        setCooldown(15);
        throw new Error("This email is registered as a patient, not staff.");
      }
